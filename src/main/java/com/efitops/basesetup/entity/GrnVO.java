...
public class GrnVO {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "grn_basicgen")
	@SequenceGenerator(name = "grn_basicgen", sequenceName = "grn_basicseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "grn_basic_id", columnDefinition = "BIGINT DEFAULT 0")
	private Long id;
	...
	@OneToMany(mappedBy = "grnVO", cascade = CascadeType.ALL)
	@JsonManagedReference
	private List<GrnTaxDetailsVO> grnTaxDetailsVO;
