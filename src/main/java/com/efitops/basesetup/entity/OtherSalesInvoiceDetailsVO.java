...
@Entity
@Table(name = "other_sales_inv_detail")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class OtherSalesInvoiceDetailsVO {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "other_sales_inv_detailgen")
	@SequenceGenerator(name = "other_sales_inv_detailgen", sequenceName = "other_sales_inv_detailseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "other_sales_inv_detail_id", columnDefinition = "BIGINT DEFAULT 0")
	private Long id;
