...
@Entity
@Table(name = "production_sch_order_short_close_basic")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ProductionSchOrderShortCloseVO {
	...
	private String screenName = "ProductionSchOrderShortClose";

	@Column(name = "screen_code")
	private String screenCode = "PSOSC";
	...
	@OneToMany(mappedBy = "productionSchOrderShortCloseVO", cascade = CascadeType.ALL)
	@JsonManagedReference
	private List<ProductionOrderDetailsVO> productionOrderDetailsVO;
