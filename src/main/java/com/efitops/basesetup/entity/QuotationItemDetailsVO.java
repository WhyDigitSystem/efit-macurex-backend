...
public class QuotationItemDetailsVO {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "quotation_detailgen")
	@SequenceGenerator(name = "quotation_detailgen", sequenceName = "quotation_detailseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "quotation_detail_id", columnDefinition = "BIGINT DEFAULT 0")
	private Long id;
