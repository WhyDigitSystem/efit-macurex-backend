...
//
//@Entity
//@Table(name = "stock_transfer_chellan_tax_detail")
//@Data
//@AllArgsConstructor
//@NoArgsConstructor
...
//
//    @Id
//    @GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "stocktransferchellantaxdetailgen")
//    @SequenceGenerator(name = "stocktransferchellantaxdetailgen",sequenceName = "stocktransferchellantaxdetailseq",initialValue = 1000000001,allocationSize = 1)
//    @Column(name = "stock_transfer_chellan_tax_detail_id")
//    private Long id;
//    
//    @ManyToOne
