...
@Entity
@Table(name = "subcontractgrn")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class SubContractGrnVO {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "subcontractgrngen")
	@SequenceGenerator(name = "subcontractgrngen", sequenceName = "subcontractgrnseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "subcontractgrnid")
	private Long id;
	...
	@Column(name = "dcno")
	private String dcNo;
	@Column(name = "jobworkoutorderdocid")
	...
	private String screenCode = "SGRN";
	@Column(name = "screenname", length = 30)
	private String screenName = "SUBCONTRACTGRN";
	...
	@OneToMany(mappedBy = "subContractGrnVO", cascade = CascadeType.ALL)
	@JsonManagedReference
	List<SubContractGrnDetailsVO> subContractGrnDetailsVO;
