...
public interface PartyMasterRepo extends JpaRepository<PartyMasterVO, Long> {
	...
	boolean existsByPartyTypeIgnoreCaseAndPartyNameIgnoreCaseAndOrgId(String partyType, String partyName, Long orgId);

	boolean existsByPartyTypeIgnoreCaseAndPartyNameIgnoreCaseAndOrgIdAndIdNot(String partyType, String partyName,
			Long orgId, Long id);
