...
//            Long branchId);
	...
	@Query(value = """
			...
			""", nativeQuery = true)
	Set<Object[]> getSalesRejectionInvoiceItemDetailsForSalesRetuen(@Param("invoiceId") String invoiceId,
	...
	@Query(value = """
			...
			ORDER BY im.item_code
			""", nativeQuery = true)
	Set<Object[]> getItemDetailsForSalesReturn(@Param("orgId") Long orgId, @Param("branch") Long branch);
