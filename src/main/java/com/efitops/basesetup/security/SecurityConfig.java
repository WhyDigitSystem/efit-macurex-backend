	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.cors().and().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().csrf()
				...
				.antMatchers("/v2/api-docs", "/configuration/ui", "/swagger-resources/**", "/configuration/security",
						...
						,"/api/jobOrder/**","/api/deletestock/**","/api/detailsSubmissionToBank/**","/api/exportpackinglist/**","/api/stockreconcilation/**","/api/NotificationDesignationController/**","/api/ticketcontroller/**","/api/toolmanagement/files/**","/api/screen/**","/api/notificationcontroller/**","/investmentfiles/**","/api/develop/**","/api/develop/**","/api/dev/**","/api/itemMaster/**","/api/partyMaster/**","/api/dhinesh/**","/api/quotationservice/**","/api/transportbill/**","/api/quotationservice/file/**","/api/quotationservice/**","/api/orderAcceptance/**","/api/purchaseMaster/**","/api/otherSalesInvoice/**","/api/rejectionInvoice/**","/api/purchasedeliveryschedule/**","/api/purchaseOrder/**","/api/purchaseservice/**","/api/grn/**","/api/inwardinspection/**","/api/initialPlanning/**","/api/toolmaster/**","/api/subContract/**","/api/purchasereturn/**","/api/reasonmaster/**","/api/vendorComplaintEntry/**","/api/engineeringchangenote/**")
